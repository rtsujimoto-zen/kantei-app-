---
name: favicon-gen
description: Generate complete favicon packages (SVG, ICO, PNG, manifest) from logos or monograms with all required formats and sizes
---
...
- **Circle** - Universal, safe choice
- **Rounded Square** - Modern, matches iOS
- **Shield** - Security, protection industries
...
**Prevention**: Hard refresh (Ctrl+Shift+R), clear cache, or version favicon URL
...
|------------|------------|-------|------|
| #0066cc (blue) | #ffffff (white) | 6.3:1 | ✅ |
| #1a1a1a (dark) | #ffffff (white) | 17.9:1 | ✅ |
| #cccccc (light gray) | #ffffff (white) | 1.6:1 | ❌ |
